...
void menu_2(sum * new_f, int * new_mass_x)
{
	...
	while (exit)
	{
		...
		omega_out2(new_f);
		cout << endl;
		cout << "1. Ручной однократный ввод данных на вход дихотомического персептрона." << endl;
		cout << "2. Автоматический ввод данных на вход дихотомического персептрона." << endl;
